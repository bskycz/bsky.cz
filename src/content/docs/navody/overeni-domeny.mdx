...
<Steps>
	...
	5. Poté se přepněte do **administrace vaší domény** a vytvořte na svém doménovém serveru `TXT` záznam s hodnotou,
	kterou
...
**Ne**, o své sledující změnou přezdívky nepřijdete. Všichni, kdo vás sledují, zůstanou propojeni s vaším účtem i po
změně handle. Automaticky vás budou sledovat pod vaším novým handlem, aniž by museli cokoliv dělat nebo měnit.

## Odkazy

- [How to verify your Bluesky account](https://bsky.social/about/blog/4-28-2023-domain-handle-tutorial) - tutoriál
od Bluesky